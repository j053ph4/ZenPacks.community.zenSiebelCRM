...
class siebelComponentMap(PythonPlugin):
    ...
    def collect(self, device, log):
        ...
        print "initializing srvrmgr"
        self.siebel.initialize(device.zSiebelGateway,device.zSiebelEnterprise,device.zSiebelServer,device.zSiebelUser,device.zSiebelPassword,120)
        components = {}
